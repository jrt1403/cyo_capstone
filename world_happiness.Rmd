...
The _World Happiness Report 2021_ (hereafter, WHR) is the ninth such report and is the focus of this assigned project (HarvardX (edX) Data Science Professional Certificate: PH125.9x Choose Your Own Capstone project). 
...
As mentioned above, the _World Happy Report 2021_ dataset is available from numerous sources including multiple sources on www.kaggle.com.  Many of those files, however, cannot be downloaded without logging into an account or otherwise registering.  So for the convenience of those who will read or review this report, I have posted a copy of the three required files (r, rmd, and pdf) to my project Github repository.  I recommend that you pull all four files to your RStudio IDE. 

My public Github repository can be found at: https://github.com/jrt1403/cyo_capstone.git
...
#PLEASE NOTE: This code chunk is set to automatidcally load the data file from my public Github repo:  https://github.com/jrt1403/cyo_capstone.git.  If, however, you prever to pull all four files (r, rmd. pdf, and csv) from Github directly, I recomment you set this chunk to eval = FALSE to prevent the automatic download.  
