...
#NOTE: eval = FASLE for this code chunk to make it easier to review the code of this RMD file.  If you want to run the code or knit to pdf output yourself, please download/pull the files, including the data file from my Github repo:  https://github.com/jrt1403/cyo_capstone.git  and change eval status to eval = TRUE.
...
#Acquire / load data
library(readr)
urlfile="https://raw.githubusercontent.com/jrt1403/cyo_capstone/main/world-happiness-report-2021.csv"
